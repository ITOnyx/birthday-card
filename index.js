const contentLetterSrart_actived = "Gửi em yêu của anh." //Lời mở đầu cho bức thư
...
document.querySelector(".contentLetter").innerText = ""; // Để trống ban đầu
document.querySelector(".mainContent").innerText = mainContentLetter;
...
document.querySelector(".letter-start").innerText = contentLetterSrart_actived;
document.querySelector(".letter-content").innerText = mainContentLetter;
